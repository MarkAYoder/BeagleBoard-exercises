...
var stop = 0;  // Set to 1 when code in eval() should stop
...
// These functions execute the code generated by Blockly
...
function setLight(r, g, blue, led) {
    // console.log("setLight(" + r + ", " + g + ", " + blue + ", " + led + ")");
    b.writeTextFile(file, r + " " + g + " " + blue + " " + led);
}
...
io.sockets.on('connection', function (socket) {
    ...
    socket.on('runCode', function (params) {
    	console.log("runCode: " + params.code);
        stop = 0;
        eval(params.code);
	});

    socket.on('stop', function (params) {
    	console.log("stop: " + params.code);
        stop = 1;
	});
