...
#####
# This is a custom 'getting started' script, made with care for Mark.A.Yoder@Rose-Hulman.edu.
...
streamer = Streamer(bucket_name="Python Stream Example", bucket_key="python_example", access_key="RdWtHlEJV0FIH1X4REFw44OfMxxJEdne")
